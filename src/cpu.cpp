...
{
    U8 opcode = mem->fetch(reg.getProgramCounter());
...
void Cpu::writeMem(RegID memPointer, U8 data)
{
    ...
    /* Get and return the data from memory. */
    mem->write(memLocation, data);
}


// /**
//  * Fetches 8 bits pointed by the program counter and stores it in a register.
//  */
// void Cpu::executeLD8(U8* reg)
// {
//     *reg = fetchNextInstruction();
// }
//
//
// /**
//  * Fetches 8 bits pointed by the program counter and stores it in register (HL).
//  */
// void Cpu::executeLD8(U16* reg)
// {
//     *reg = fetchNextInstruction();
// }
//
//
// /**
//  * Copies the value from register 2 into register 1.
//  */
// void Cpu::executeLD8(U8* reg, U8 val)
// {
//     *reg = val;
// }
...
U16 Cpu::executePOP()
{
    ...
    U8 val = mem->fetchU16(reg.getStackPointer());
...
int Cpu::executeJR(int conditionFlag)
{
    ...
    ||(conditionFlag == COND_C  && carry == true))
    {
        U16 newPC = reg.getProgramCounter() - 1 + step;
...
int Cpu::executeInstruction(U8 opcode)
{
    ...
    switch(opcode)
    {
        ...
        case 0x8: /* LD a16, SP */
            ...
            mem->write(dest, (U8) (src16 & 0xff));
            dest++;
            mem->write(dest, (U8) (src16 >> 8));
            cycles = 5;
            break;
        case 0x9: /* ADD HL, BC */
        ...
        case 0x21: /* LD HL, d16 */
            ...
            reg.write16(RegID_HL, fetchNext16Bits());
            cycles = 3;
            break;
        case 0x22: /* LD (HL+), A */
            Log::printVerbose("LD (HL+), d16");
        ...
        case 0xF0: /* LD A, (a8) */
            ...
            src = mem->fetch(0xff00 + fetchNextInstruction());
            reg.write8(RegID_A, src);
            cycles = 3;
            break;
        case 0xF1: /* POP AF */
        ...
        case 0xF2: /* LD A, (C) */
            Log::printVerbose("LD A, (C)");
            src = mem->fetch(0xff00 + reg.read8(RegID_C));
            reg.write8(RegID_A, src);
            cycles = 2;
            break;
        // case 0xF3:
